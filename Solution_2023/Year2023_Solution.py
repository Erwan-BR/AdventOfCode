...
class Year2023_Solution(Solution):
    """
    Class containing the method for having solution of problems of year 2023.
    """
    ...
    def getSolution(day: str, isFirstPart: bool):
        ...
        """
        return Solution.getSolution(Year2023_Solution, Year2023_Solution.year, day, isFirstPart)
